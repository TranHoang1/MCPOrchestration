...
| Bridge Token | Long-lived JWT (7-30 days) for MCP Bridge client authentication |
...
```xml
<mxfile>
  <diagram name="System Context - Per-User Credentials">
    <mxGraphModel dx="1422" dy="762" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1169" pageHeight="827" math="0" shadow="0">
      <root>
        <mxCell id="0" />
        <mxCell id="1" parent="0" />
        <!-- IDE User -->
        <mxCell id="2" value="IDE User&#xa;(Kiro / VS Code)" style="shape=actor;whiteSpace=wrap;html=1;" vertex="1" parent="1">
          <mxGeometry x="80" y="320" width="80" height="100" as="geometry" />
        </mxCell>
        <!-- Admin User -->
        <mxCell id="3" value="Admin User&#xa;(Web Portal)" style="shape=actor;whiteSpace=wrap;html=1;" vertex="1" parent="1">
          <mxGeometry x="80" y="120" width="80" height="100" as="geometry" />
        </mxCell>
        <!-- MCP Bridge -->
        <mxCell id="4" value="MCP Bridge&#xa;(orchestrator-bridge)" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#dae8fc;strokeColor=#6c8ebf;" vertex="1" parent="1">
          <mxGeometry x="280" y="330" width="160" height="60" as="geometry" />
        </mxCell>
        <!-- Orchestrator Server -->
        <mxCell id="5" value="MCP Orchestrator Server&#xa;(orchestrator-server)&#xa;&#xa;• JWT Auth Middleware&#xa;• Credential Resolver&#xa;• Process Pool Manager&#xa;• User Management" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#d5e8d4;strokeColor=#82b366;" vertex="1" parent="1">
          <mxGeometry x="520" y="200" width="240" height="160" as="geometry" />
        </mxCell>
        <!-- PostgreSQL -->
        <mxCell id="6" value="PostgreSQL&#xa;&#xa;• users&#xa;• credential_schemas&#xa;• user_credentials&#xa;• mcp_servers" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#fff2cc;strokeColor=#d6b656;" vertex="1" parent="1">
          <mxGeometry x="560" y="460" width="160" height="120" as="geometry" />
        </mxCell>
        <!-- Upstream MCP Servers -->
        <mxCell id="7" value="Upstream MCP Servers&#xa;(Jira, GitHub, etc.)&#xa;&#xa;Process Pool" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#f8cecc;strokeColor=#b85450;" vertex="1" parent="1">
          <mxGeometry x="860" y="260" width="180" height="80" as="geometry" />
        </mxCell>
        <!-- Identity Provider -->
        <mxCell id="8" value="Identity Provider&#xa;(Azure AD / Okta / Keycloak)" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#e1d5e7;strokeColor=#9673a6;" vertex="1" parent="1">
          <mxGeometry x="520" y="40" width="240" height="60" as="geometry" />
        </mxCell>
        <!-- Edges -->
        <mxCell id="e1" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="2" target="4" parent="1">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="e2" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="4" target="5" parent="1">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="e3" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="3" target="5" parent="1">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        ...
        <mxCell id="e6" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="5" target="8" parent="1">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <!-- Edge Labels -->
        <mxCell id="el1" value="stdio" style="edgeLabel;html=1;" vertex="1" connectable="0" parent="e1">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="el2" value="HTTP + JWT" style="edgeLabel;html=1;" vertex="1" connectable="0" parent="e2">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="el3" value="HTTP + JWT" style="edgeLabel;html=1;" vertex="1" connectable="0" parent="e3">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="el4" value="JDBC + HikariCP" style="edgeLabel;html=1;" vertex="1" connectable="0" parent="e4">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="el5" value="stdio / HTTP&#xa;(per-user creds)" style="edgeLabel;html=1;" vertex="1" connectable="0" parent="e5">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="el6" value="OAuth2/OIDC" style="edgeLabel;html=1;" vertex="1" connectable="0" parent="e6">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
      </root>
    </mxGraphModel>
...
| 3 | | Generate bridge token | Long-lived JWT (configurable 7-30 days) |
...
| ID | Condition | Steps |
|----|-----------|-------|
| AF-1 | Custom expiry requested | Validate within 1-90 days range, use requested value |
...
| BR-002 | Bridge token expires in 7-30 days (configurable, max 90) | MTO-95 AC |
...
```xml
<mxfile>
  <diagram name="ER Diagram - Credential Management">
    <mxGraphModel dx="1422" dy="762" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1169" pageHeight="827" math="0" shadow="0">
      <root>
        <mxCell id="0" />
        <mxCell id="1" parent="0" />
        <!-- users table (existing) -->
        <mxCell id="2" value="users (existing)&#xa;─────────────────&#xa;PK id: UUID&#xa;email: VARCHAR(255)&#xa;name: VARCHAR(255)&#xa;role: VARCHAR(50)&#xa;active: BOOLEAN&#xa;password_hash: VARCHAR(255) [NEW]&#xa;auth_mode: VARCHAR(10) [NEW]&#xa;failed_login_attempts: INT [NEW]&#xa;locked_until: TIMESTAMP [NEW]&#xa;created_at: TIMESTAMP&#xa;updated_at: TIMESTAMP" style="shape=table;startSize=30;container=0;collapsible=0;childLayout=tableLayout;fixedRows=1;rowLines=1;fontStyle=1;align=left;overflow=fill;whiteSpace=wrap;html=0;" vertex="1" parent="1">
          <mxGeometry x="80" y="100" width="280" height="260" as="geometry" />
        </mxCell>
        <!-- credential_schemas table (new) -->
        <mxCell id="3" value="credential_schemas [NEW]&#xa;─────────────────────&#xa;PK id: UUID&#xa;FK server_name: VARCHAR(100)&#xa;field_key: VARCHAR(50)&#xa;field_label: VARCHAR(100)&#xa;field_type: VARCHAR(20)&#xa;field_required: BOOLEAN&#xa;field_description: TEXT&#xa;field_placeholder: VARCHAR(200)&#xa;display_order: INT&#xa;created_at: TIMESTAMP&#xa;updated_at: TIMESTAMP" style="shape=table;startSize=30;container=0;collapsible=0;childLayout=tableLayout;fixedRows=1;rowLines=1;fontStyle=1;align=left;overflow=fill;whiteSpace=wrap;html=0;" vertex="1" parent="1">
          <mxGeometry x="480" y="100" width="280" height="240" as="geometry" />
        </mxCell>
        <!-- user_credentials table (new) -->
        <mxCell id="4" value="user_credentials [NEW]&#xa;──────────────────&#xa;PK id: UUID&#xa;FK user_id: UUID&#xa;server_name: VARCHAR(100)&#xa;credentials: TEXT (encrypted JSONB)&#xa;created_at: TIMESTAMP&#xa;updated_at: TIMESTAMP" style="shape=table;startSize=30;container=0;collapsible=0;childLayout=tableLayout;fixedRows=1;rowLines=1;fontStyle=1;align=left;overflow=fill;whiteSpace=wrap;html=0;" vertex="1" parent="1">
          <mxGeometry x="80" y="420" width="280" height="160" as="geometry" />
        </mxCell>
        <!-- bridge_tokens table (new) -->
        <mxCell id="5" value="bridge_tokens [NEW]&#xa;────────────────&#xa;PK id: UUID&#xa;FK user_id: UUID&#xa;token_hash: VARCHAR(64)&#xa;expires_at: TIMESTAMP&#xa;revoked: BOOLEAN&#xa;created_at: TIMESTAMP" style="shape=table;startSize=30;container=0;collapsible=0;childLayout=tableLayout;fixedRows=1;rowLines=1;fontStyle=1;align=left;overflow=fill;whiteSpace=wrap;html=0;" vertex="1" parent="1">
          <mxGeometry x="480" y="420" width="280" height="160" as="geometry" />
        </mxCell>
        <!-- mcp_servers table (existing) -->
        <mxCell id="6" value="mcp_servers (existing)&#xa;─────────────────────&#xa;PK name: VARCHAR(100)&#xa;command: TEXT&#xa;args: TEXT[]&#xa;env: JSONB&#xa;transport: VARCHAR(20)&#xa;enabled: BOOLEAN" style="shape=table;startSize=30;container=0;collapsible=0;childLayout=tableLayout;fixedRows=1;rowLines=1;fontStyle=1;align=left;overflow=fill;whiteSpace=wrap;html=0;" vertex="1" parent="1">
          <mxGeometry x="860" y="100" width="240" height="160" as="geometry" />
        </mxCell>
        <!-- sso_config table (new) -->
        <mxCell id="7" value="sso_config [NEW]&#xa;──────────────&#xa;PK id: UUID&#xa;sso_enabled: BOOLEAN&#xa;issuer_url: TEXT&#xa;client_id: VARCHAR(255)&#xa;client_secret_encrypted: TEXT&#xa;scopes: VARCHAR(500)&#xa;callback_url: TEXT&#xa;claims_mapping: JSONB&#xa;default_role: VARCHAR(50)&#xa;jit_provisioning: BOOLEAN&#xa;updated_at: TIMESTAMP" style="shape=table;startSize=30;container=0;collapsible=0;childLayout=tableLayout;fixedRows=1;rowLines=1;fontStyle=1;align=left;overflow=fill;whiteSpace=wrap;html=0;" vertex="1" parent="1">
          <mxGeometry x="860" y="320" width="260" height="240" as="geometry" />
        </mxCell>
        <!-- Relationships -->
        <mxCell id="r1" value="1:N" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="2" target="4" parent="1">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="r2" value="1:N" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="2" target="5" parent="1">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
        <mxCell id="r3" value="1:N" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="6" target="3" parent="1">
          <mxGeometry relative="1" as="geometry" />
        </mxCell>
      </root>
    </mxGraphModel>
...
| expires_at | TIMESTAMP | Yes | 1-90 days from creation | Token expiry |
...
```xml
<mxfile>
  <diagram name="Authentication Flow">
    <mxGraphModel dx="1422" dy="762" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1169" pageHeight="827" math="0" shadow="0">
      <root>
        <mxCell id="0" />
        <mxCell id="1" parent="0" />
        <!-- Start -->
        <mxCell id="2" value="" style="ellipse;fillColor=#000000;" vertex="1" parent="1">
          <mxGeometry x="360" y="40" width="30" height="30" as="geometry" />
        </mxCell>
        <!-- Decision: Auth Mode -->
        <mxCell id="3" value="Auth Mode?" style="rhombus;whiteSpace=wrap;" vertex="1" parent="1">
          <mxGeometry x="310" y="100" width="130" height="80" as="geometry" />
        </mxCell>
        <!-- Local Auth -->
        <mxCell id="4" value="Validate&#xa;Username/Password" style="rounded=1;whiteSpace=wrap;" vertex="1" parent="1">
          <mxGeometry x="140" y="220" width="160" height="60" as="geometry" />
        </mxCell>
        <!-- SSO Auth -->
        <mxCell id="5" value="Redirect to IdP&#xa;OAuth2/OIDC" style="rounded=1;whiteSpace=wrap;" vertex="1" parent="1">
          <mxGeometry x="450" y="220" width="160" height="60" as="geometry" />
        </mxCell>
        <!-- Decision: Valid? -->
        <mxCell id="6" value="Valid?" style="rhombus;whiteSpace=wrap;" vertex="1" parent="1">
          <mxGeometry x="170" y="320" width="100" height="80" as="geometry" />
        </mxCell>
        <!-- Issue JWT -->
        <mxCell id="7" value="Issue JWT&#xa;Session Token" style="rounded=1;whiteSpace=wrap;" vertex="1" parent="1">
          <mxGeometry x="310" y="440" width="130" height="60" as="geometry" />
        </mxCell>
        <!-- Error -->
        <mxCell id="8" value="Return 401&#xa;Error" style="rounded=1;whiteSpace=wrap;fillColor=#f8cecc;" vertex="1" parent="1">
          <mxGeometry x="40" y="440" width="100" height="60" as="geometry" />
        </mxCell>
        <!-- End -->
        <mxCell id="9" value="" style="ellipse;fillColor=#000000;strokeColor=#000000;" vertex="1" parent="1">
          <mxGeometry x="360" y="540" width="30" height="30" as="geometry" />
        </mxCell>
        <!-- Edges -->
        <mxCell id="e1" edge="1" source="2" target="3" parent="1" />
        <mxCell id="e2" value="local" edge="1" source="3" target="4" parent="1" />
        <mxCell id="e3" value="sso" edge="1" source="3" target="5" parent="1" />
        <mxCell id="e4" edge="1" source="4" target="6" parent="1" />
        <mxCell id="e5" value="yes" edge="1" source="6" target="7" parent="1" />
        <mxCell id="e6" value="no" edge="1" source="6" target="8" parent="1" />
        <mxCell id="e7" edge="1" source="5" target="7" parent="1" />
        <mxCell id="e8" edge="1" source="7" target="9" parent="1" />
      </root>
    </mxGraphModel>
  </diagram>
</mxfile>
...
| Bridge token | Bridge JWT | 7-30 days | IDE bridge client |
...
auth:
  jwt:
    ...
    bridge-token-max-expiry-days: 90          # Maximum allowed
  lockout:
...
```xml
<mxfile>
  <diagram name="Data Flow - Credential Resolution">
    <mxGraphModel dx="1422" dy="762" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1169" pageHeight="827" math="0" shadow="0">
      <root>
        <mxCell id="0" />
        <mxCell id="1" parent="0" />
        <!-- External entities -->
        <mxCell id="2" value="IDE User" style="shape=rectangle;rounded=0;whiteSpace=wrap;fillColor=#f5f5f5;" vertex="1" parent="1">
          <mxGeometry x="40" y="200" width="100" height="40" as="geometry" />
        </mxCell>
        <mxCell id="3" value="Upstream&#xa;MCP Server" style="shape=rectangle;rounded=0;whiteSpace=wrap;fillColor=#f5f5f5;" vertex="1" parent="1">
          <mxGeometry x="1000" y="200" width="100" height="40" as="geometry" />
        </mxCell>
        <!-- Processes -->
        <mxCell id="4" value="1.0&#xa;Authenticate&#xa;User" style="ellipse;whiteSpace=wrap;fillColor=#dae8fc;" vertex="1" parent="1">
          <mxGeometry x="220" y="180" width="120" height="80" as="geometry" />
        </mxCell>
        <mxCell id="5" value="2.0&#xa;Resolve&#xa;Credentials" style="ellipse;whiteSpace=wrap;fillColor=#dae8fc;" vertex="1" parent="1">
          <mxGeometry x="440" y="180" width="120" height="80" as="geometry" />
        </mxCell>
        <mxCell id="6" value="3.0&#xa;Acquire&#xa;Process" style="ellipse;whiteSpace=wrap;fillColor=#dae8fc;" vertex="1" parent="1">
          <mxGeometry x="660" y="180" width="120" height="80" as="geometry" />
        </mxCell>
        <mxCell id="7" value="4.0&#xa;Execute&#xa;Tool" style="ellipse;whiteSpace=wrap;fillColor=#dae8fc;" vertex="1" parent="1">
          <mxGeometry x="860" y="180" width="120" height="80" as="geometry" />
        </mxCell>
        <!-- Data stores -->
        <mxCell id="8" value="D1: users" style="shape=partialRectangle;whiteSpace=wrap;fillColor=#fff2cc;" vertex="1" parent="1">
          <mxGeometry x="220" y="340" width="120" height="30" as="geometry" />
        </mxCell>
        <mxCell id="9" value="D2: user_credentials" style="shape=partialRectangle;whiteSpace=wrap;fillColor=#fff2cc;" vertex="1" parent="1">
          <mxGeometry x="440" y="340" width="140" height="30" as="geometry" />
        </mxCell>
        <mxCell id="10" value="D3: process_pool" style="shape=partialRectangle;whiteSpace=wrap;fillColor=#fff2cc;" vertex="1" parent="1">
          <mxGeometry x="660" y="340" width="120" height="30" as="geometry" />
        </mxCell>
        <!-- Data flows -->
        <mxCell id="f1" value="JWT token" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="2" target="4" parent="1" />
        <mxCell id="f2" value="user_id + server" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="4" target="5" parent="1" />
        <mxCell id="f3" value="pool_key + config" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="5" target="6" parent="1" />
        <mxCell id="f4" value="connection" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="6" target="7" parent="1" />
        <mxCell id="f5" value="tool request" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="7" target="3" parent="1" />
        <mxCell id="f6" value="validate" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="4" target="8" parent="1" />
        <mxCell id="f7" value="decrypt" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="5" target="9" parent="1" />
        <mxCell id="f8" value="acquire/release" style="edgeStyle=orthogonalEdgeStyle;" edge="1" source="6" target="10" parent="1" />
      </root>
    </mxGraphModel>
  </diagram>
</mxfile>
