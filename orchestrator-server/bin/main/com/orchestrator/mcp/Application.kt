        ...
        "stdio" -> {
            ...
            this@runBlocking.launch {
                try {
                    ...
                    // Register hidden tools before indexing
                    HiddenToolRegistrar.registerHiddenTools(
...
private fun logConnectionResults(
    ...
    val connected = states.values.count {
        it.status == com.orchestrator.mcp.client.upstream.model.ServerState.CONNECTED
    }
